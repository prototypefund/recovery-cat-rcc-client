...
export class CustomQuestionEditPage implements OnInit {
	...
	public async save(): Promise<any>{
		...
		try{			
			...
			this.rccToastController.present({message:'CUSTOM_QUESTION_STORE.EDIT.SAVE_SUCCESS'})
		} catch (reason) {
			console.warn(reason) //TODO
			this.rccToastController.present({message:'CUSTOM_QUESTION_STORE.EDIT.SAVE_FAILURE'})
		}
