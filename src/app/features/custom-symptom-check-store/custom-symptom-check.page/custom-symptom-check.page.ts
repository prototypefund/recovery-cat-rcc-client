...
import	{
			ScheduleModal
		}									from '../schedule.modal/schedule.modal'


@Component({
	selector: 		'rcc-custom-symptom-check-page',
	templateUrl: 	'./custom-symptom-check.page.html',
	styleUrls: 		['./custom-symptom-check.page.scss']
})
export class CustomSymptomCheckPage {
	...
	public async editSchedule(schedule: Schedule){
		return await 	this.rccModalController.present(ScheduleModal, { schedule })
